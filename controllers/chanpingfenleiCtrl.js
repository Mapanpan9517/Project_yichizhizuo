var ChanpingFenlei = require("../models/ChanpingFenlei.js");
var formidable = require("formidable");


// //获取信息
exports.GetXinxi = function(req,res){
    ChanpingFenlei.find().exec(function(err,content){
        if(!err){
...
exports.AddXinxi = function(req,res){
    ...
    form.parse(req,function(err,content){
        ...
        // console.log(Xinxi)
        ChanpingFenlei.create(Xinxi,function(err,content){
            if(!err){
...
exports.DeleteXinxi = function(req,res){
    ...
    ChanpingFenlei.remove({"_id":id}).exec(function(err,content){
        if(!err){
...
exports.ChangeXinxi = function(req,res){
    ...
    form.parse(req,function(err,content){
        ...
        // console.log(Xinxi)
        ChanpingFenlei.update({_id},{$set:Xinxi},function(err,content){
            if(!err){
