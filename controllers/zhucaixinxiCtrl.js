var ZhucaiXinxi = require("../models/ZhucaiXinxi.js");
var formidable = require("formidable");


// //获取信息
exports.GetXinxi = function(req,res){
    ZhucaiXinxi.find().exec(function(err,content){
        if(!err){
...
exports.AddXinxi = function(req,res){
    ...
    form.parse(req,function(err,content){
        ...
        // console.log(Xinxi)
        ZhucaiXinxi.create(Xinxi,function(err,content){
            if(!err){
...
exports.DeleteXinxi = function(req,res){
    ...
    ZhucaiXinxi.remove({"_id":id}).exec(function(err,content){
        if(!err){
...
exports.ChangeXinxi = function(req,res){
    ...
    form.parse(req,function(err,content){
        ...
        // console.log(Xinxi)
        ZhucaiXinxi.update(ChangeBy,{$set:Xinxi},function(err,content){
            if(!err){
